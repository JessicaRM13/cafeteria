                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('productos.update', $producto->id) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="precio_compra" type="text"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="precio_venta" type="text"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="proveedor" class="form-control @error('proveedor') is-invalid @enderror"
                                        ...
                                        <option value="{{ $producto->proveedor->id }}" selected>
                                            {{ $producto->proveedor->nombre }}</option>
                                        @foreach ($proveedores as $proveedor)
                                            <option value="{{ $proveedor->id }}"> {{-- {{ $producto->idproveedor == $proveedor->id ? 'selected' : '' }}> --}}
                                                {{ $proveedor->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
